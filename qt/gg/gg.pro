...
# depend on your compiler). Please consult the documentation of theF
...
INCLUDEPATH += D:\Code\Qt\Tools\mingw530_64\mingw32\include
LIBS += -L D:\Code\Qt\Tools\mingw530_64\mingw32\lib -lmingw32 -mwindows -mconsole -lSDL2main -lSDL2
CXXFLAGS = -std=c++11
